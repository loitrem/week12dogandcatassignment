    ...
    return (
        ...
        <div className="animalDisplayWrapper">
            <div className="animalDisplay">
                <div className='form'>
                    <form action="/dogaddsubmit" method="POST">
                    <div className="inputWrapper">
                        ...
                        <div className="inputWrapper">
                            ...
                            <div className="inputTag"><input className='input' type="text" name="breed" /></div>
                        </div>
                        <div className="inputWrapper">
                        ...
                        <div className="inputWrapper">
                            <input className='inputSubmit' type="submit" name="" value="Add Dog" />
                        </div>
                    </form>
                </div>
            </div>
